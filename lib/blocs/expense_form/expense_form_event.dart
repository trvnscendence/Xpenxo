...
final class ExpenseSplitInfoChanged extends ExpenseFormEvent {
  const ExpenseSplitInfoChanged(this.splitInfos);

  final List<SplitInfo> splitInfos;

  @override
  List<Object> get props => [splitInfos];
}
